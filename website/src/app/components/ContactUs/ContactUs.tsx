...
export default function ContactSection() {
  return (
    <section id="contact" className="relative py-32 bg-linear-to-br from-white via-blue-50 to-indigo-50 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-blue-400/15 rounded-full blur-3xl animate-blob" />
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-indigo-400/15 rounded-full blur-3xl animate-blob animation-delay-2000" />
      </div>

      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto opacity-0 animate-fade-in-up">
          {/* Header - matching the site's header style */}
          <div className="text-center mb-20 opacity-0 animate-fade-in-up animation-delay-200">
            <div className="container mx-auto px-4 relative z-10">
