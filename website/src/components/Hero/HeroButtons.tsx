  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-6 mt-12">
      ...
      <a
        ...
        className="group relative inline-flex h-14 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 px-8 font-medium text-white transition-all duration-300 hover:w-full sm:hover:w-auto hover:scale-105 shadow-lg shadow-amber-500/30 hover:shadow-[0_0_40px_8px_rgba(245,158,11,0.3)] focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 focus:ring-offset-slate-900"
      >
